...
- I merged the pull request on Github and left the branch there incase it is needed again later. As mentioned in the first video link, theoretically it can be kept for a few weeks to make sure it is no longer needed, after that it can be deleted after a discussion with the project team, or when deemed appropriate by the project manager.  
