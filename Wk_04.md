...
\
Vagrant is a script like software with a main Vagrant file that standardises and automates VM deployment. It works with free VM software _VirtualBox_ by Oracle
